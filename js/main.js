  ...
  $(".tabs").click(function () {
    ...
    switch (selectedTabId) {
      case "tab-1":
        ...
        switchGlossary("1", glossaryAbo, example1, example2, example3);
        break;
      case "tab-2":
        example1 =
        ...
        switchGlossary("2", glossaryNewspaper, example1, example2, example3);
        break;
      case "tab-3":
